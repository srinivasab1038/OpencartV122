...
public class ExtentReportManager extends BaseClass implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		*/
		...
		extent.setSystemInfo("User Name", System.getProperty("user.name")); //User name will be fetched from environment variables
		extent.setSystemInfo("Environemnt", "QA");
		
		String os = testContext.getCurrentXmlTest().getParameter("os"); //OS will be fetched from testng.xml
		extent.setSystemInfo("Operating System", os);
		
		String browser = testContext.getCurrentXmlTest().getParameter("browser");   //Browser will be fetched from testng.xml
		extent.setSystemInfo("Browser", browser);
		
		List<String> includedGroups = testContext.getCurrentXmlTest().getIncludedGroups(); //included groups will be fetched from testng.xml
	...
	public void onTestSuccess(ITestResult result) {
		...
		test = extent.createTest(result.getTestClass().getName()); //to display testclass name in report
